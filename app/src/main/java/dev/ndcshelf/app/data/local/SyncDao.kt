...
interface SyncDao {
    ...
    suspend fun getOperationCountersAfter(deviceId: String, after: Long): List<Long>
    ...
    suspend fun updateOperationState(operationIds: List<String>, state: String): Int
    ...
    suspend fun pruneAcknowledgedOperations(deviceId: String, counter: Long): Int

    @Query(
        "SELECT * FROM sync_field_states WHERE entityType = :entityType AND entityId = :entityId",
    )
    suspend fun getFieldStates(entityType: String, entityId: String): List<SyncFieldStateEntity>
    ...
    suspend fun deleteFieldStates(entityType: String, entityId: String): Int

    @Query("SELECT * FROM sync_tombstones WHERE entityType = :entityType AND entityId = :entityId")
    suspend fun findTombstone(entityType: String, entityId: String): SyncTombstoneEntity?
    ...
    suspend fun deleteTombstone(entityType: String, entityId: String): Int
    ...
    suspend fun resolveConflict(conflictId: String, resolutionOperationId: String): Int
    ...
    suspend fun deleteUnresolvedDependenciesForEntity(entityType: String, entityId: String): Int

    @Query(
        "SELECT COUNT(*) FROM sync_unresolved_dependencies " +
            "WHERE entityType = :entityType AND entityId = :entityId",
    )
    suspend fun countUnresolvedDependencies(entityType: String, entityId: String): Int
