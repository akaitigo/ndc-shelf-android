...
fun BookWorkEntity.toSyncUpsert() = SyncMutation.Upsert(
    "work",
    id,
    mapOf(
...
fun BookEditionEntity.toSyncUpsert() = SyncMutation.Upsert(
    "edition",
    id,
    mapOf(
...
fun OwnedCopyEntity.toSyncUpsert() = SyncMutation.Upsert(
    "ownedCopy",
    id,
    mapOf(
...
fun WishlistItemEntity.toSyncUpsert() = SyncMutation.Upsert(
    "wishlistItem",
    editionId,
    mapOf(
...
fun LocationRoomEntity.toSyncUpsert() = SyncMutation.Upsert(
    "locationRoom",
    id,
    mapOf("name" to JsonPrimitive(name), "sortOrder" to JsonPrimitive(sortOrder)),
)

fun LocationShelfEntity.toSyncUpsert() = SyncMutation.Upsert(
    "locationShelf",
    id,
    mapOf(
...
fun LocationTierEntity.toSyncUpsert() = SyncMutation.Upsert(
    "locationTier",
    id,
    mapOf(
...
fun SeriesEntity.toSyncUpsert() = SyncMutation.Upsert(
    "series",
    id,
    mapOf(
        "name" to JsonPrimitive(name),
...
fun SeriesMembershipEntity.toSyncUpsert() = SyncMutation.Upsert(
    "seriesMembership",
    id,
    mapOf(
...
fun WorkGroupEntity.toSyncUpsert() = SyncMutation.Upsert(
    "workGroup",
    id,
    mapOf(
        "title" to JsonPrimitive(title),
...
fun WorkGroupMembershipEntity.toSyncUpsert() = SyncMutation.Upsert(
    "workGroupMembership",
    id,
    mapOf(
...
fun syncDelete(entityType: String, entityId: String) = SyncMutation.Delete(entityType, entityId)
